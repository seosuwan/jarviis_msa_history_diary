...
from drawing.names import QUICK_DRAWING_FILES, QUICK_DRAWING_NAMES

BINARY_URL = "https://storage.googleapis.com/quickdraw_dataset/full/binary/"
CACHE_DIR = path.join("quickdraw_api", ".quickdrawcache")
...
class QuickDrawDataGroup():
    ...
    def _download_drawings_binary(self, url, filename):
        ...
        try:
            ...
            raise Exception(
                "connection error - you need to be connected to the internet to download {} drawings".format(
                    self._name))
